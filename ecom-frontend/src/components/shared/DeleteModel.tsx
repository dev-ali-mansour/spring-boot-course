...
export const DeleteModal: React.FC<DeleteModalProps> = ({open, setOpen, title, onDeleteHandler, isLoading,}) => {
    return (
                ...
                <div className={"flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0"}>
                    <DialogPanel
                        ...
                        className={`relative transform overflow-hidden rounded-lg bg-white px-4 pb-4 pt-5 
                            ...
                            data-leave:duration-200 data-enter:ease-out sm:my-8 sm:w-full sm:max-w-lg sm:p-6 
