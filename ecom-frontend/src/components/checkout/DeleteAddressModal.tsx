...
const DeleteAddressModal: React.FC<DeleteAddressModalProps> = (
    {isOpen, setIsOpen, title, isLoading, onDeleteHandler}
) => {
    return (
                ...
                <div className={"flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0"}>
                    <DialogPanel
                        ...
                        className={`relative transform overflow-hidden rounded-lg bg-white px-4 pb-4 pt-5 text-left 
                            ...
                            data-enter:duration-300 data-enter:ease-out sm:my-8 sm:w-full sm:max-w-lg 
                            sm:p-6 sm:data-closed:translate-y-0 sm:data-closed:scale-95`}>
                        ...
                        <div className={"mt-5 sm:mt-4 sm:flex sm:flex-row-reverse"}>
                            <button
                                ...
                                className={`inline-flex w-full bg-customRed justify-center rounded-md 
                                    bg-red-600 px-3 py-2 text-sm font-semibold text-white shadow-xs 
                            ...
                            <button
                                ...
                                className={`mt-3 inline-flex w-full justify-center rounded-md bg-white px-3 
                                    py-2 text-sm font-semibold text-gray-900 shadow-xs ring-1 ring-inset 
